...
import entities.jsf.util.JsfUtil;
import entities.jsf.util.PaginationHelper;
...
public class AttendanceController implements Serializable {
    ...
    @EJB
    private entities.AttendanceFacade ejbFacade;
    ...
    public Attendance getAttendance(java.lang.Integer id) {
    ...
    public static class AttendanceControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getAttendance(getKey(value));
        }
